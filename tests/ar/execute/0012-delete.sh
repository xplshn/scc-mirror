...
$EXEC ${BINDIR}scc-ar -dv file.a file1 file2

if $EXEC ${BINDIR}scc-ar -tv file.a file1 file2
then
...
cp master.a file.a
$EXEC ${BINDIR}scc-ar -dv file.a file1 file2 file3
...
if test `$EXEC ${BINDIR}scc-ar -t file.a | wc -l` -ne 0
then
...
if $EXEC ${BINDIR}scc-ar -dv file.a badfile
then
